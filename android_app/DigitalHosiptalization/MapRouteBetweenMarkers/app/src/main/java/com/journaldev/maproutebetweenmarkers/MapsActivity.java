...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng origin =  new LatLng(getIntent().getDoubleExtra("sourcelatitude",0.0),getIntent().getDoubleExtra("sourcelongitude",0.0));

        LatLng dest = new LatLng(getIntent().getDoubleExtra("destlatitude",0.0),getIntent().getDoubleExtra("destlongitude",0.0));
